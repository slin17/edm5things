...
public class All extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youTubeView = (YouTubePlayerView) findViewById(R.id.youtube_view_edm5things_all);
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.loadVideo("1y6smkh6c-0"); // AutoPlays https://www.youtube.com/watch?v=1y6smkh6c-0
        }
    }
    ...
    private final class MyPlayerStateChangeListener implements YouTubePlayer.PlayerStateChangeListener {
        ...
        public void onVideoStarted() {
            ...
            showMessage("This is Swedish House Mafia's last song. Please enjoy.");
        }

        @Override
        public void onVideoEnded() {
            // Called when the video reaches its end.
            showMessage("Thank you for using EDM5things.");
        }

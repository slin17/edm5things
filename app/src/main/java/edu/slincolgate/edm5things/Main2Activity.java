...
public class Main2Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youTubeView = (YouTubePlayerView) findViewById(R.id.youtube_view_shm);
        youTubeView.initialize(Config.YOUTUBE_API_KEY, this);

        playerStateChangeListener = new MyPlayerStateChangeListener();
        playbackEventListener = new MyPlaybackEventListener();

        Button back = (Button) findViewById(R.id.back_button_shm);
    ...
    // upon initialization success
        ...
        if (!wasRestored) {
            player.cueVideo("PDboaDrHGbA"); // Plays https://www.youtube.com/watch?v=PDboaDrHGbA
        }
    }

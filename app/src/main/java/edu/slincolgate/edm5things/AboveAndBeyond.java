...
public class AboveAndBeyond extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_above_and_beyond);

        youTubeView = (YouTubePlayerView) findViewById(R.id.youtube_view_above_n_beyond);
        ...
        Button back = (Button) findViewById(R.id.back_button_above_n_beyond);
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.cueVideo("UsbLGsrPCXk"); // Plays https://www.youtube.com/watch?v=UsbLGsrPCXk
        }
    }
